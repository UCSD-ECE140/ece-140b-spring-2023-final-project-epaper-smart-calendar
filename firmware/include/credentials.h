...
*/
String OWMapikey = "placeholder";                   // See: https://openweathermap.org/ //FIXME

//PRIVATE CALENDAR URL

String googleAPI = "placeholder";
String Lattitude = "00.00";                      // Your lattitude - use google maps //FIXME
String Longitude = "00.00";                      // Your longitude - use google maps //FIXME
