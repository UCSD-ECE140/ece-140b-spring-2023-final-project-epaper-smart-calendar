...
int portalTimeoutTime = 90; // Seconds to wait before showing calendar
...
bool obtain_wx_data(const String& RequestType) {
  ...
  String weatherURL = String("https://") + OWMserver + "/data/3.0/onecall?" +"lat=" + Lattitude + "&lon=" + Longitude + "&appid=" + OWMapikey + "&mode=json&units=" + units + "&lang=" + Language;
